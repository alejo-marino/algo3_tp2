...
public class TestRondaInicial {
    ...
    void test07CreoUnaRondaInicialYPuedoReforzarDosPaisesPropios () {
        Pais argentina = ronda.seleccionarPais("Argentina", jugador1);
        ronda.reforzar(3);
        Pais chile = ronda.seleccionarPais("Chile", jugador1);
        ronda.reforzar(2);
    ...
    void test08CreoUnaRondaInicialYPasoDeTurnoYNoPuedoReforzarPaisDeJugadorAnterior () {
        ...
        assertThrows(SeleccionaPaisAjenoException.class, () -> ronda.seleccionarPais("Argentina", jugador2));
    }
